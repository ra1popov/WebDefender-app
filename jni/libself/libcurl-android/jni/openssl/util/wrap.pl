...
BEGIN {
    ...
    require '/Users/romanpopov/Documents/Projects/Android/WebDefender/jni/libself/libcurl-android/jni/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/romanpopov/Documents/Projects/Android/WebDefender/jni/libself/libcurl-android/jni/openssl/test/fips-and-base.cnf';
    shift;
