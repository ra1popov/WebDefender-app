...
public class FragmentWhitelistBindingImpl extends FragmentWhitelistBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_whitelist_empty, 4);
    }
    // views
    @NonNull
    ...
    public FragmentWhitelistBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentWhitelistBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((app.ui.whitelist.WhitelistHandler) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((app.ui.whitelist.WhitelistViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable app.ui.whitelist.WhitelistHandler Handler) {
        this.mHandler = Handler;
    }
    public void setViewModel(@Nullable app.ui.whitelist.WhitelistViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        app.ui.whitelist.WhitelistViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            app.ui.whitelist.WhitelistFragment.setWhitelist(this.rvWhitelist, viewModelListGetValue);
        }
    }
