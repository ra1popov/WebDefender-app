...
@Keep
public abstract class BaseDialog2<T, BD extends ViewBinding, B extends BuilderDialog<T>> extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(requireActivity(), R.style.Theme_WebDefender_Dialog2);
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            windowParams.dimAmount = 0.4f; // windowParams.dimAmount = 0.7f;
